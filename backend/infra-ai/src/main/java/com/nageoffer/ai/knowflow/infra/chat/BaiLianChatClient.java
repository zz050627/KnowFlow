...
public class BaiLianChatClient implements ChatClient {
    ...
    private JsonArray buildMessages(ChatRequest request) {
        ...
        List<com.nageoffer.ai.knowflow.framework.convention.ChatMessage> messages = request.getMessages();
        if (CollUtil.isNotEmpty(messages)) {
            for (com.nageoffer.ai.knowflow.framework.convention.ChatMessage m : messages) {
    ...
    private String toOpenAiRole(com.nageoffer.ai.knowflow.framework.convention.ChatMessage.Role role) {
        return switch (role) {
            case SYSTEM -> "system";
            case USER -> "user";
