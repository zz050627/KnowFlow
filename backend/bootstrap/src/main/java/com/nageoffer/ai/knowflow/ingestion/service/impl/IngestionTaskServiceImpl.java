...
package com.nageoffer.ai.knowflow.ingestion.service.impl;
...
import com.nageoffer.ai.knowflow.rag.controller.request.DocumentSourceRequest;
import com.nageoffer.ai.knowflow.ingestion.controller.request.IngestionTaskCreateRequest;
import com.nageoffer.ai.knowflow.ingestion.controller.vo.IngestionTaskNodeVO;
import com.nageoffer.ai.knowflow.ingestion.controller.vo.IngestionTaskVO;
import com.nageoffer.ai.knowflow.ingestion.dao.entity.IngestionTaskDO;
import com.nageoffer.ai.knowflow.ingestion.dao.entity.IngestionTaskNodeDO;
import com.nageoffer.ai.knowflow.ingestion.dao.mapper.IngestionTaskMapper;
import com.nageoffer.ai.knowflow.ingestion.dao.mapper.IngestionTaskNodeMapper;
...
import com.nageoffer.ai.knowflow.ingestion.domain.context.DocumentSource;
import com.nageoffer.ai.knowflow.ingestion.domain.context.IngestionContext;
import com.nageoffer.ai.knowflow.ingestion.domain.context.NodeLog;
import com.nageoffer.ai.knowflow.ingestion.domain.enums.IngestionNodeType;
import com.nageoffer.ai.knowflow.ingestion.domain.enums.IngestionStatus;
import com.nageoffer.ai.knowflow.ingestion.domain.enums.SourceType;
import com.nageoffer.ai.knowflow.ingestion.domain.pipeline.NodeConfig;
import com.nageoffer.ai.knowflow.ingestion.domain.pipeline.PipelineDefinition;
import com.nageoffer.ai.knowflow.ingestion.domain.result.IngestionResult;
import com.nageoffer.ai.knowflow.ingestion.engine.IngestionEngine;
import com.nageoffer.ai.knowflow.ingestion.util.MimeTypeDetector;
...
import com.nageoffer.ai.knowflow.ingestion.service.IngestionTaskService;
