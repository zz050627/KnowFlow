...
package com.nageoffer.ai.knowflow.knowledge.service.impl;
...
import com.nageoffer.ai.knowflow.core.chunk.ChunkEmbeddingService;
import com.nageoffer.ai.knowflow.core.chunk.ChunkingMode;
import com.nageoffer.ai.knowflow.core.chunk.ChunkingOptions;
import com.nageoffer.ai.knowflow.core.chunk.ChunkingStrategy;
import com.nageoffer.ai.knowflow.core.chunk.ChunkingStrategyFactory;
import com.nageoffer.ai.knowflow.core.chunk.VectorChunk;
import com.nageoffer.ai.knowflow.core.parser.DocumentParserSelector;
import com.nageoffer.ai.knowflow.core.parser.ParserType;
import com.nageoffer.ai.knowflow.framework.context.UserContext;
import com.nageoffer.ai.knowflow.framework.exception.ClientException;
import com.nageoffer.ai.knowflow.framework.mq.producer.MessageQueueProducer;
import com.nageoffer.ai.knowflow.infra.keyword.KeywordExtractor;
import com.nageoffer.ai.knowflow.ingestion.dao.entity.IngestionPipelineDO;
import com.nageoffer.ai.knowflow.ingestion.dao.mapper.IngestionPipelineMapper;
import com.nageoffer.ai.knowflow.ingestion.domain.context.IngestionContext;
import com.nageoffer.ai.knowflow.ingestion.domain.pipeline.PipelineDefinition;
import com.nageoffer.ai.knowflow.ingestion.engine.IngestionEngine;
import com.nageoffer.ai.knowflow.ingestion.service.IngestionPipelineService;
import com.nageoffer.ai.knowflow.knowledge.config.KnowledgeScheduleProperties;
import com.nageoffer.ai.knowflow.knowledge.controller.request.KnowledgeChunkCreateRequest;
import com.nageoffer.ai.knowflow.knowledge.controller.request.KnowledgeDocumentPageRequest;
import com.nageoffer.ai.knowflow.knowledge.controller.request.KnowledgeDocumentUpdateRequest;
import com.nageoffer.ai.knowflow.knowledge.controller.request.KnowledgeDocumentUploadRequest;
import com.nageoffer.ai.knowflow.knowledge.controller.vo.KnowledgeChunkVO;
import com.nageoffer.ai.knowflow.knowledge.controller.vo.KnowledgeDocumentChunkLogVO;
import com.nageoffer.ai.knowflow.knowledge.controller.vo.KnowledgeDocumentSearchVO;
import com.nageoffer.ai.knowflow.knowledge.controller.vo.KnowledgeDocumentVO;
import com.nageoffer.ai.knowflow.knowledge.dao.entity.KnowledgeBaseDO;
import com.nageoffer.ai.knowflow.knowledge.dao.entity.KnowledgeDocumentChunkLogDO;
import com.nageoffer.ai.knowflow.knowledge.dao.entity.KnowledgeDocumentDO;
import com.nageoffer.ai.knowflow.knowledge.dao.mapper.KnowledgeBaseMapper;
import com.nageoffer.ai.knowflow.knowledge.dao.mapper.KnowledgeDocumentChunkLogMapper;
import com.nageoffer.ai.knowflow.knowledge.dao.mapper.KnowledgeDocumentMapper;
import com.nageoffer.ai.knowflow.knowledge.enums.DocumentStatus;
import com.nageoffer.ai.knowflow.knowledge.enums.ProcessMode;
import com.nageoffer.ai.knowflow.knowledge.enums.SourceType;
import com.nageoffer.ai.knowflow.knowledge.handler.RemoteFileFetcher;
import com.nageoffer.ai.knowflow.knowledge.mq.event.KnowledgeDocumentChunkEvent;
import com.nageoffer.ai.knowflow.knowledge.schedule.CronScheduleHelper;
import com.nageoffer.ai.knowflow.knowledge.service.KnowledgeChunkService;
import com.nageoffer.ai.knowflow.knowledge.service.KnowledgeDocumentScheduleService;
import com.nageoffer.ai.knowflow.knowledge.service.KnowledgeDocumentService;
import com.nageoffer.ai.knowflow.rag.core.vector.VectorSpaceId;
import com.nageoffer.ai.knowflow.rag.core.vector.VectorStoreService;
import com.nageoffer.ai.knowflow.rag.dto.StoredFileDTO;
import com.nageoffer.ai.knowflow.rag.service.FileStorageService;
